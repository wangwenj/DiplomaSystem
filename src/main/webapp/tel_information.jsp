...
<%
    List<User> userList= (List<User>) request.getAttribute("allTelInfo");
%>
<!DOCTYPE html>
<html lang="en">
<head>
        ...
        <div class="ibox ">
            <div class="ibox-content">
                <div class="example-wrap">
                    </button><h2 class="example-title" style="display: inline-block;">通讯录</h2>
                    <div class="example">
                        ...
                        <table id="exampleTableEvents" data-height="auto" data-mobile-responsive="true">
                            <thead>
                            <tr>
                                <th data-field="departName" class="col-lg-2">名字</th>
                                <th data-field="departId" class="col-lg-2">电话号码</th>
                                <th data-field="intro" class="col-lg-2">联系地址</th>
                            </tr>
                            </thead>
                            <tbody>
                            <%
